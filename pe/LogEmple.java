...
public class LogEmple extends javax.swing.JFrame
{
    ...
    private void initComponents() {
        ...
        btnIniciarSecion = new javax.swing.JLabel();
        ...
        btnIniciarSecion.setBackground(new java.awt.Color(0, 118, 255));
        btnIniciarSecion.setFont(new java.awt.Font("Arial", 1, 22)); // NOI18N
        btnIniciarSecion.setForeground(new java.awt.Color(255, 255, 255));
        btnIniciarSecion.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnIniciarSecion.setText("Iniciar sesión");
        btnIniciarSecion.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        btnIniciarSecion.setOpaque(true);
        btnIniciarSecion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                btnIniciarSecionMouseClicked(evt);
            }
        });
        jPanel2.add(btnIniciarSecion, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 435, 350, 40));
    ...
    {//GEN-HEADEREND:event_btnIniciarSecionMouseClicked
    ...
    private javax.swing.JLabel btnIniciarSecion;
